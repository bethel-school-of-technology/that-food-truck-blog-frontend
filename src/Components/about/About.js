  ...
  return (
    <div className='About'>
      ...
      <p className='card-body mb-2'>
        {' '}
        Our hearts are to share and expand the Gospel of Jesus through our Food
        Truck Businesses. Our goal is that all would know Jesus would encounter
        the love of God through our food, and those that don't know the Fathers
        love would encounter His love for them. Every meal is made in excellence
        knowing we want our customers to taste the goodness of God in every
        bite.
      </p>
      <img
      ...
      <p className='container text-center'>
        ...
        <h4> Creativity & Growth </h4> We are always looking for different ways
        to expand our menu from glory to glory.
      </p>
